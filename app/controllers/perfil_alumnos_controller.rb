class PerfilAlumnosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @perfil_alumno.save
        format.html { redirect_to @perfil_alumno, notice: 'Perfil alumno was successfully created.' }
  ...
  private
    ...
    def perfil_alumno_params
      params.require(:perfil_alumno).permit(:user_id, :matricula, :ap_paterno, :ap_materno, :nombre, :fecha_de_nacimiento, :genero_id, :calle, :numero_exterior, :numero_interior, :colonia, :delegacion_municipio, :codigo_postal, :telefono_casa, :telefono_celular, :telefono_recados, :extension_recados, :grupo_id, :generacion_id, :perfil_tutor_id)
    end
end
