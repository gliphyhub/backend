...
class PublicacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacion" do
    assert_difference('Publicacion.count') do
      post publicaciones_url, params: { publicacion: { fecha_de_termino: @publicacion.fecha_de_termino, mensaje: @publicacion.mensaje, prioridad: @publicacion.prioridad, titulo: @publicacion.titulo } }
    end
  ...
  test "should update publicacion" do
    patch publicacion_url(@publicacion), params: { publicacion: { fecha_de_termino: @publicacion.fecha_de_termino, mensaje: @publicacion.mensaje, prioridad: @publicacion.prioridad, titulo: @publicacion.titulo } }
