...
class ComunicadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comunicado" do
    assert_difference('Comunicado.count') do
      post comunicados_url, params: { comunicado: { fecha_de_termino: @comunicado.fecha_de_termino, mensaje: @comunicado.mensaje, mensaje_markdown: @comunicado.mensaje_markdown, perfil_admin_id: @comunicado.perfil_admin_id, prioridad: @comunicado.prioridad, titulo: @comunicado.titulo } }
    end
  ...
  test "should update comunicado" do
    patch comunicado_url(@comunicado), params: { comunicado: { fecha_de_termino: @comunicado.fecha_de_termino, mensaje: @comunicado.mensaje, mensaje_markdown: @comunicado.mensaje_markdown, perfil_admin_id: @comunicado.perfil_admin_id, prioridad: @comunicado.prioridad, titulo: @comunicado.titulo } }
